 ...
 * One of the things HTTP can do is called content negotiation. T
 * he Accept request header is used to tell the server what type of document the client would like to get.
 ...
 *
 * The URL https://eloquentjavascript.net/author is configured to respond with either plaintext, HTML, or JSON,
 ...
 *
 * Send requests to fetch all three formats of this resource. Use the headers property in the options object passed
 * to fetch to set the header named Accept to the desired media type.
 *
